...
export const siteConfig: SiteConfig = {
	title: "Night Rain in the Garden",
	subtitle: "",
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/Momordicin/fuwari-claudef", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/11179609",
		},
		// {
		// 	name: "Steam",
		...
		// },
		{
			...
			url: "https://github.com/Momordicin",
		},
	],
};
